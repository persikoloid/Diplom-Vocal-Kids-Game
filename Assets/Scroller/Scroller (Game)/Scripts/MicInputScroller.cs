...
class Peak4
{
    ...
    public Peak4(float _frequency, int _index)
    {
...
class AmpComparer4 : IComparer<Peak4>
{
    public int Compare(Peak4 a, Peak4 b)
    {
        return 0 - a.amplitude.CompareTo(b.amplitude);
    }
}
 
class IndexComparer4 : IComparer<Peak4>
{
    public int Compare(Peak4 a, Peak4 b)
    {
...
public class MicInputScroller : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        player = GameObject.FindWithTag("ScrollerPlayer");
