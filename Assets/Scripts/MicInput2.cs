...
class Peak2
{
    ...
    public Peak2(float _frequency, int _index)
    {
...
class AmpComparer2 : IComparer<Peak2>
{
    public int Compare(Peak2 a, Peak2 b)
    {
        return 0 - a.amplitude.CompareTo(b.amplitude);
    }
}
 
class IndexComparer2 : IComparer<Peak2>
{
    public int Compare(Peak2 a, Peak2 b)
    {
...
public class MicInput2 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        player = GameObject.FindWithTag("MazePlayer");
